...
\newcommand{\afterskip}{.8\onelineskip minus .2ex}
...
\setlength{\parskip}{.5\onelineskip} %.5\onelineskip
\setlength{\partopsep}{-1.5ex} %-1.5ex
\setlength{\parsep}{\onelineskip} %\onelineskip
\let\oldenumerate\enumerate
\renewcommand{\enumerate}{
    \oldenumerate
    \setlength{\itemsep}{.5\onelineskip}
...
\usepackage{enumitem}
\setlist[itemize]{nosep,itemsep=.5\onelineskip}
