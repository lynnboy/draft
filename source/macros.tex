...
\newcommand{\ExitBlockb}[1]{\textit{\,---end #1}]\xspace}
\newcommand{\ExitBlock}[1]{\,]\xspace}
\newcommand{\enternote}{\EnterBlock{Note}}
\newcommand{\exitnote}{\ExitBlock{note}}
\newcommand{\exitnoteb}{\ExitBlockb{note}}
\newcommand{\enterexample}{\EnterBlock{Example}}
\newcommand{\exitexample}{\ExitBlock{example}}
\newcommand{\exitexampleb}{\ExitBlockb{example}}

%% Library function descriptions
\newcommand{\Fundescx}[1]{\textbf{#1}\xspace}
